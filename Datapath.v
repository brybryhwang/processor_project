module Datapath(
    ...
    wire [15:0]writeData_n;
    wire [15:0] readData1, readData2, aluInB, aluResult, memReadData, writeData;

    RegisterFile rf(clk, regWrite, rs1, rs2, rd, writeData, readData1, readData2,debug_r0,debug_r1,debug_r2,writeData_n);
